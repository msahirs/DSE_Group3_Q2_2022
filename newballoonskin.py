...
print('number gasbags',gasbags)

r = (1+(1/3)) * r_solarpanels

thickness_skin = 1.2 * d_P_gas * r / (2*admissiblestress)
...
print('altitude',h)
print('width',width)
print('m skin latex',mass_skin_latex)
print('m skin fibre',mass_skinfibre)
