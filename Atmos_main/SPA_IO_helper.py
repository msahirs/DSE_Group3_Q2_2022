...
file_b = os.path.join(cwd,"data","input_archive","PA_16200","SPA_output.csv")
file_a = os.path.join(cwd,"data","input_archive","PA_16200","sweep_parameters.csv")

merge_CSVs(file_a,file_b,"data/input_archive/PA_16200")
