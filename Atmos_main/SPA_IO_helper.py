...
file_b = os.path.join(cwd,"data","input_archive","slope_valid","SPA_output.csv")
file_a = os.path.join(cwd,"data","input_archive","Slope_valid","sweep_parameters.csv")

merge_CSVs(file_a,file_b,"data/input_archive/slope_valid")
