...
APP_NAME = "SPA.exe"
APP_PATH = ""
EXP_DATA = os.path.join(curr_dir,"data","input_archive","North_0","sweep_parameters.csv")
...
def main():
    ...
    np.savetxt("./data/input_archive/North_0/SPA_output.csv", SPA_output, fmt = "%.3f", delimiter= ","
