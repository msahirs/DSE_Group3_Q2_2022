...
APP_NAME = "SPA.exe"
APP_PATH = ""
EXP_DATA = os.path.join(curr_dir,"data","input_archive","relev_locs","sweep_parameters_SA.csv")
...
def main():
    ...
    np.savetxt("./data/input_archive/relev_locs/SPA_output_SA.csv", SPA_output, fmt = "%.3f", delimiter= ","
