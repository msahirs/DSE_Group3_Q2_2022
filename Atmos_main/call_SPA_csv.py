...
APP_NAME = "SPA.exe"
APP_PATH = ""
EXP_DATA = os.path.join(curr_dir,"data","input_archive","relev_locs_zero","sweep_parameters_NL.csv")
...
def main():
    ...
    np.savetxt("./data/input_archive/relev_locs_zero/SPA_output.csv", SPA_output, fmt = "%.3f", delimiter= ","
