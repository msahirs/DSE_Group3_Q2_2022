...
ref_angle_inp = "2022 7 22 12 30 0 2.0 0 69.184 4.36 52 20000 54.75 -56.5 0 0 0.556 1".split(" ")
...
# sweep_params = np.array(np.meshgrid(hour_sweep,minute_sweep,day_sweep,month_sweep)).T.reshape(-1,4)
