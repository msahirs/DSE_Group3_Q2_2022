...
INP_DATA_FILE = os.path.join(curr_dir,"data","input_archive","PA_16200","merged_noLines.csv")
...
def main():
    ...
    with open(os.path.join(curr_dir,"data","input_archive","PA_16200",OUTPUT_DATA_FILE), 'w',) as f:\
