...
INP_DATA_FILE = os.path.join(curr_dir,"data","input_archive","elev_2","merged_noLines.csv")
...
def main():
    ...
    with open(os.path.join(curr_dir,"data","input_archive","elev_2",OUTPUT_DATA_FILE), 'w',) as f:\
