...
ref_angle_inp = "2023 1 18 13 45 0 2 0 69.184 4.35 52.0 0 1013.25 15 0 0 0.65 1".split(" ")
...
np.savetxt("./data/input_archive/elev_2/sweep_parameters.csv", main_data, fmt = "%.2f", delimiter= ","
